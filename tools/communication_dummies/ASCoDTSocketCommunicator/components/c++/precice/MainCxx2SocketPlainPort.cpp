...
precice::MainCxx2SocketPlainPort::MainCxx2SocketPlainPort(char const* host,int port,int buffer_size):
     ...
     precice::MainCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

precice::MainCxx2SocketPlainPort::MainCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //precice::MainCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

precice::MainCxx2SocketPlainPort::~MainCxx2SocketPlainPort(){
     int method=-1;
     ...
     precice::MainCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int precice::MainCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int precice::MainCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}
...
/*
void precice::MainCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void precice::MainCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void precice::MainCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void precice::MainCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void precice::MainCxx2SocketPlainPort::main(){
...
void precice::MainCxx2SocketPlainPort::mainParallel(){
     //assert(_destination!=NULL);
#ifdef _WIN32
#else
     int flags;
