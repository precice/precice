...
public abstract class FSIDataAbstractSocketPort extends SocketComponent implements FSIDataSocketPort{

  protected FSIData  _destination;
  
  public FSIDataAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public FSIDataAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
