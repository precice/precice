...
public class FSIDataSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<FSIData>  _destinations;
  
  public FSIDataSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<FSIData>();
