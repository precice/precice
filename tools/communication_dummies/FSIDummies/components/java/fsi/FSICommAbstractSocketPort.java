...
public abstract class FSICommAbstractSocketPort extends SocketComponent implements FSICommSocketPort{

  protected FSIComm  _destination;
  
  public FSICommAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public FSICommAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
