...
public class FSITestSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<FSITest>  _destinations;
  
  public FSITestSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<FSITest>();
