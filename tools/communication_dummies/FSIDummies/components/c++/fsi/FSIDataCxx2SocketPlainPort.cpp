...
fsi::FSIDataCxx2SocketPlainPort::FSIDataCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     fsi::FSIDataCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

fsi::FSIDataCxx2SocketPlainPort::FSIDataCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //fsi::FSIDataCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

fsi::FSIDataCxx2SocketPlainPort::~FSIDataCxx2SocketPlainPort(){
     int method=-1;
     ...
     fsi::FSIDataCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int fsi::FSIDataCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int fsi::FSIDataCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void fsi::FSIDataCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void fsi::FSIDataCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void fsi::FSIDataCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void fsi::FSIDataCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void fsi::FSIDataCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void fsi::FSIDataCxx2SocketPlainPort::transferData(const int* coordId, const int coordId_len,const double* data, const int data_len){
...
void fsi::FSIDataCxx2SocketPlainPort::transferDataParallel(const int* coordId, const int coordId_len,const double* data, const int data_len){
     //assert(_destination!=NULL);
#ifdef _WIN32
#else
     int flags;
...
void fsi::FSIDataCxx2SocketPlainPort::dataAck(int& ack){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
int flags;
...
void fsi::FSIDataCxx2SocketPlainPort::dataAckParallel(int& ack){
     //assert(_destination!=NULL);
#ifdef _WIN32
#else
     int flags;
