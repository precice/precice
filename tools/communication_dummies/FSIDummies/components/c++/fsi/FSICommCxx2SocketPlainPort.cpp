...
fsi::FSICommCxx2SocketPlainPort::FSICommCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     fsi::FSICommCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

fsi::FSICommCxx2SocketPlainPort::FSICommCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //fsi::FSICommCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

fsi::FSICommCxx2SocketPlainPort::~FSICommCxx2SocketPlainPort(){
     int method=-1;
     ...
     fsi::FSICommCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int fsi::FSICommCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int fsi::FSICommCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void fsi::FSICommCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void fsi::FSICommCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void fsi::FSICommCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void fsi::FSICommCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void fsi::FSICommCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
