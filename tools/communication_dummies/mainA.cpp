...
main(int argc, char** argv) {
  ...
  if (utils::MasterSlave::_masterMode) {
    ...
    pMesh->getVertexDistribution()[0].push_back(7);

    pMesh->getVertexDistribution()[1].push_back(2);
    pMesh->getVertexDistribution()[1].push_back(4);
    pMesh->getVertexDistribution()[1].push_back(5);
    pMesh->getVertexDistribution()[1].push_back(8);

    pMesh->getVertexDistribution()[2].push_back(6);
    pMesh->getVertexDistribution()[2].push_back(9);
  }
