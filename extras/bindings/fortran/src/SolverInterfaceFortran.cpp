                      ...
                      const int *solverProcessSize, int lengthAccessorName, int lengthConfigFileName)
{
  ...
  impl.reset(
      new precice::SolverInterface(stringAccessorName, stringConfigFileName, *solverProcessIndex, *solverProcessSize));
}
...
void precicef_write_data_required_(const double *computedTimestepLength, int *isRequired)
{
...
void precicef_action_required_(const char *action, int *isRequired, int lengthAction)
{
