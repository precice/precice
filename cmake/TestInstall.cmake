...
add_custom_target(test_install
  ...
  COMMAND ${CMAKE_COMMAND} -Dprecice_DIR=${CMAKE_INSTALL_PREFIX}/lib/cmake/precice -S ${preCICE_SOURCE_DIR}/tools/solverdummies/cpp -B ${CMAKE_CURRENT_BINARY_DIR}/TestInstall
