...
macro (MULTIPASS_SOURCE_RUNS includes libraries source runs language)
  ...
  if(CMAKE_CROSSCOMPILING AND NOT CMAKE_CROSSCOMPILING_EMULATOR)
    message(STATUS "Crosscompiling without emulator: Assuming successful run.")
    set(${testname}_EXITCODE 0 CACHE STRING "Multipass exit code")
    mark_as_advanced(${testname}_EXITCODE)
  endif()
