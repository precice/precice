...
{
  PRECICE_TEST();
  // Test case for a just-in-time mapping, where the access region is empty
  // Here, SolverOne does not receive any vertices due to the defined bounding
  // box. Each solver runs on two ranks. SolverTwo defines 5(2 and 3)
