...
tarch::logging::Log MPICommunicationTest::
  _log ("precice::com::tests::MPICommunicationTest");
...
void MPICommunicationTest:: testSendAndReceiveString()
{
...
void MPICommunicationTest:: testSendAndReceiveVector ()
{
  ...
  if ( utils::Parallel::getProcessRank() == 0 ) {
    ...
    com.send (tarch::la::raw(msg), msg.size(), 1);
    com.receive (tarch::la::raw(msg), msg.size(), 1);
...
void MPICommunicationTest:: testSendAndReceiveInteger ()
{
...
void MPICommunicationTest:: testSendAndReceiveFromAnySender()
{
