...
public:
  explicit InverseMultiquadrics(double c) : _cPow2(std::pow(c, 2))
  {
    PRECICE_CHECK(math::greater(c, 0.0),
                  "Shape parameter for radial-basis-function inverse multiquadric has to be "
...
public:
      ...
      : _shape(shape), _supportRadius(supportRadius)
  {
    PRECICE_CHECK(math::greater(_shape, 0.0),
                  "Shape parameter for radial-basis-function gaussian has to be larger "
...
public:
  explicit CompactThinPlateSplinesC2(double supportRadius) : _r(supportRadius)
  {
    PRECICE_CHECK(math::greater(_r, 0.0),
                  "Support radius for radial-basis-function compact thin-plate-splines c2 has "
...
public:
  ...
  {
    PRECICE_CHECK(math::greater(_r, 0.0),
                  "Support radius for radial-basis-function compact polynomial c0 has to be "
...
public:
  ...
  {
    PRECICE_CHECK(math::greater(_r, 0.0),
                  "Support radius for radial-basis-function compact polynomial c6 has to be "
                  "larger than zero. Please update the \"support-radius\" attribute.");
  }
