...
registerTest(precice::io::tests::ExportVTKXMLTest)
...
void ExportVTKXMLTest:: testExportPolygonalMesh()
{
  ...
  ExportVTKXML exportVTKXML(exportNormals);
  std::ostringstream filename;
  filename << "io-ExportVTKXMLTest-testExportPolygonalMesh";
  std::string location = "";
  exportVTKXML.doExport ( filename.str(), location, mesh );
...
void ExportVTKXMLTest:: testExportTriangulatedMesh()
{
  ...
  ExportVTKXML exportVTKXML(exportNormals);
  std::ostringstream filename;
  filename << "io-ExportVTKXMLTest-testExportTriangulatedMesh";
  std::string location = "";
  exportVTKXML.doExport ( filename.str(), location, mesh );
...
void ExportVTKXMLTest:: testExportQuadMesh()
{
  ...
  ExportVTKXML exportVTKXML(exportNormals);
  std::ostringstream filename;
  filename << "io-ExportVTKXMLTest-testExportQuadMesh";
  std::string location = "";
  exportVTKXML.doExport(filename.str(), location, mesh);
