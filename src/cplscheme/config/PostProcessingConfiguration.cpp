    ...
    xml::XMLTag &tag)
{
  ...
  if (tag.getName() == VALUE_CONSTANT) {
    ...
    auto validQR1 = makeValidatorEquals<std::string>(VALUE_QR1FILTER);
    auto validQR1abs = makeValidatorEquals<std::string>(VALUE_QR1_ABSFILTER);
    auto validQR2 = makeValidatorEquals<std::string>(VALUE_QR2FILTER);
    ...
    auto valid1 = makeValidatorEquals<std::string>(VALUE_CONSTANT_PRECONDITIONER);
    auto valid2 = makeValidatorEquals<std::string>(VALUE_VALUE_PRECONDITIONER);
    auto valid3 = makeValidatorEquals<std::string>(VALUE_RESIDUAL_PRECONDITIONER);
    auto valid4 = makeValidatorEquals<std::string>(VALUE_RESIDUAL_SUM_PRECONDITIONER);
    ...
    auto validNO_RS = makeValidatorEquals<std::string>(VALUE_NO_RESTART);
    auto validRS_ZERO = makeValidatorEquals<std::string>(VALUE_ZERO_RESTART);
    auto validRS_LS = makeValidatorEquals<std::string>(VALUE_LS_RESTART);
    auto validRS_SVD = makeValidatorEquals<std::string>(VALUE_SVD_RESTART);
    auto validRS_SLIDE = makeValidatorEquals<std::string>(VALUE_SLIDE_RESTART);
