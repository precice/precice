...
BOOST_AUTO_TEST_CASE(testExtrapolateData)
{
  ...
  // start first window
  scheme.moveToNextWindow(); // uses zeroth order extrapolation at beginning of first window
  BOOST_TEST(testing::equals(cplData->previousIteration()(0), 0.0));
  ...
  // start first window
  scheme2.moveToNextWindow(); // uses zeroth order extrapolation at beginning of first window
  BOOST_TEST(testing::equals(cplData->previousIteration()(0), 0.0));
