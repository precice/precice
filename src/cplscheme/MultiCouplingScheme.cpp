...
MultiCouplingScheme::MultiCouplingScheme(double                             maxTime,
                                         int                                maxTimeWindows,
...
void MultiCouplingScheme::addDataToSend(const mesh::PtrData &data,
                                        mesh::PtrMesh        mesh,
                                        bool                 initialize,
                                        const std::string &  to)
{
...
void MultiCouplingScheme::addDataToReceive(const mesh::PtrData &data,
                                           mesh::PtrMesh        mesh,
                                           bool                 initialize,
