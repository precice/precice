...
public:
  ...
  /** @brief: computes number of cols in least squares system, i.e, number of cols in
    ...
    *	 This is necessary only for primary-secondary mode, when some procs do not have
    ...
    *  is needed for primary-secondary communication. Number of its =! _cols in general.
    */
...
protected:
  ...
  /*
    * @brief If in primary-secondary mode: True if this process has nodes at the coupling interface
    */
  ...
  /** @brief only needed for the parallel primary-secondary mode. stores the local dimensions,
