...
#define PRECICE_VALIDATE_MESH_ID_IMPL(id)                                                                              \
  PRECICE_CHECK(_accessor->hasMesh(id), "The given Mesh ID \"{}\" is unknown to preCICE.", id);
...
#define PRECICE_VALIDATE_DATA_ID_IMPL(id)                                                                              \
  PRECICE_CHECK(_accessor->hasData(id), "The given Data ID \"{}\" is unknown to preCICE.", id);
...
#define PRECICE_VALIDATE_DATA(data, size)                                                                              \
  PRECICE_CHECK(std::all_of(data, data + size, [](double val) { return std::isfinite(val); }),                         \
                "One of the given data values is either plus or minus infinity or NaN.");
