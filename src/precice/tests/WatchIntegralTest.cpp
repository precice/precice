...
BOOST_AUTO_TEST_CASE(VectorDataNoConnectivityParallel)
{
  ...
  if(utils::MasterSlave::isMaster()){
    ...
    doubleValues(0) = 5.0; doubleValues(1) = 6.0;
    doubleValues(2) = 7.0; doubleValues(3) = 8.0;
  }
  else if(context.isRank(2)){
    doubleValues(0) = 9.0; doubleValues(1) = 10.0;
    doubleValues(2) = 11.0; doubleValues(3) = 12.0;
  }
  else if(context.isRank(3)){
    doubleValues(0) = 13.0; doubleValues(1) = 14.0;
    doubleValues(2) = 15.0; doubleValues(3) = 16.0;
  }
...

  {
    ...
    if(utils::MasterSlave::isMaster()){
      ...
      doubleValues(0) = 6.0; doubleValues(1) = 7.0;
      doubleValues(2) = 8.0; doubleValues(3) = 9.0;
    }
    else if(context.isRank(2)){
      doubleValues(0) = 10.0; doubleValues(1) = 11.0;
      doubleValues(2) = 12.0; doubleValues(3) = 13.0;
    }
    else if(context.isRank(3)){
      doubleValues(0) = 14.0; doubleValues(1) = 15.0;
      doubleValues(2) = 16.0; doubleValues(3) = 17.0;
    }
...
BOOST_AUTO_TEST_CASE(VectorDataFaceConnectivityParallel)
{
  ...
  if(context.isRank(3)){
    doubleValues(0) = 1.0; doubleValues(1) = 2.0;
    doubleValues(2) = 5.0; doubleValues(3) = 6.0;
    doubleValues(4) = 7.0; doubleValues(5) = 8.0;
  }
...

  {
    ...
    if(context.isRank(3)){
      doubleValues(0) = 2.0; doubleValues(1) = 3.0;
      doubleValues(2) = 6.0; doubleValues(3) = 7.0;
      doubleValues(4) = 8.0; doubleValues(5) = 9.0;
    }
