...
#     ifndef NDEBUG
      DEBUG ( "Detected " << _accessorGroups.size() << " groups" );
      for (const AccessorGroup& group : _accessorGroups) {
...
{
  // Do not use preciceTrace or DEBUG here!
  int processRank = 0;
# ifndef PRECICE_NO_MPI
  if (_isInitialized) {
