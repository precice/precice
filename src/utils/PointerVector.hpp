...
template <typename CONTENT_T> class ptr_vector {
public:
  ...
  typedef boost::indirect_iterator<typename container::iterator, CONTENT_T *, boost::use_default, CONTENT_T &> iterator;

  /// Type of const_iterator hiding pointers.
  typedef boost::indirect_iterator<typename container::const_iterator, CONTENT_T *, boost::use_default, CONTENT_T &>
      const_iterator;
