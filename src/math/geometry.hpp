...
bool collinear(const Eigen::MatrixBase<Derived> &a,
 ...
 */
template <typename Derived>
static bool parallel(const Eigen::MatrixBase<Derived> &a,
                     const Eigen::MatrixBase<Derived> &b,
                     const Eigen::MatrixBase<Derived> &c,
...
int containedInHyperrectangle(const Eigen::MatrixBase<Derived> &sidelengths,
...
template <class Derived>
bool parallel(const Eigen::MatrixBase<Derived> &a,
              const Eigen::MatrixBase<Derived> &b,
              const Eigen::MatrixBase<Derived> &c,
              const Eigen::MatrixBase<Derived> &d)
{
