...
{
  P_assertion(A.rows() == B.rows(), "Matrices with different number of rows can't be compared.");
  P_assertion(A.cols() == B.cols(), "Matrices with different number of cols can't be compared.");
